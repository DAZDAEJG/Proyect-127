...
# actualizacion de pip     pip install pip --upgrade
#instalar opencv----    pip install opencv-python
#instalar bs4 ---- pip install bs4
#inslatar selenium ----- pip install selenium
#activar entorno virtual ------ \Scripts\EP127\activate